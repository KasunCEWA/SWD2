...
(
  ...
  PARENT_CONSENT_FLG              VARCHAR2(1 BYTE) DEFAULT 'N',
  ...
  STUDENT_FTE                     NUMBER(2,1)   DEFAULT 1.0,
  FED_GOVT_FUNDING_EXCL_FLG       VARCHAR2(1 BYTE) DEFAULT ON NULL 'N',
